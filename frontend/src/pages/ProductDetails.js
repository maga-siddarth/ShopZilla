      ...
      <div className=" min-h-[200px] flex flex-col lg:flex-row gap-4">
        ...
        {loading ? (
          <div className="grid gap-1 w-full">
            ...
            <h2 className="text-2xl lg:text-4xl font-medium h-6 bg-slate-200 animate-pulse rounded  lg:h-8 w-full"></h2>
            <p className="capitalize text-slate-400 bg-slate-200 min-w-[100px] animate-pulse h-6 lg:h-8 w-full"></p>

            <div className="text-red-600 bg-slate-200 h-6 lg:h-8 animate-pulse flex items-center gap-1  w-full"></div>

            <div className="flex items-center gap-2 text-2xl lg:text-3xl font-medium lg:h-8 my-1 h-6 animate-pulse  w-full ">
            ...
            <div className="w-full">
              <p className="text-slate-600 font-medium my-1 h-6 lg:h-8 bg-slate-200 animate-pulse rounded  w-full">
                {" "}
              </p>
